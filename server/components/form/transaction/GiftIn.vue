<template>
  <div class="container-fluid">
    ...
    <div class="row">
      <!-- gift info -->
      <wallet-io class="col-xs-12 col-lg-6" v-model="data.in">{{$t('transaction.gift.in')}}</wallet-io>

      <!-- fee info -->
      <template v-for="(curFee, i) in data.fee">
        <wallet-io class="col-xs-12 col-lg-6" :mandatory="false" v-model="data.fee[i]">
          <div class="row">
            <div class="col-xs-6">{{$t('transaction.gift.fee')}}</div>
            <div class="col-xs-3">
      ...
      <div class="col-xs-12 col-lg-12">
        <fieldset>
          ...
          <div class="row">
            ...
            <!-- countervalue -->
            <counter-value class="col-xs-12 col-lg-6" v-model="data.in.countervalue">{{$t('transaction.gift.countervalues.in')}}</counter-value>
          </div>
        </fieldset>
      </div>
    </div>
