  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <template v-for="(curFee, i) in data.fee">
        <wallet-io class="col-xs-12 col-lg-6" :mandatory="false" :comment="true" v-model="data.fee[i]">
          <div class="row">
            <div class="col-xs-6">{{$t('transaction.income.fee')}}</div>
            <div class="col-xs-3">
    ...
    <div class="row">
      <div class="col-xs-12 col-lg-12">
        <fieldset>
          <legend>{{$t('transaction.income.exchangerates.title')}}</legend>
          <div class="row">

            <!-- exchangerate -->
            <exchange-rate class="col-xs-12 col-lg-6" v-model="data.in.exchangerate">{{$t('transaction.income.exchangerates.in')}}</exchange-rate>
          </div>
        </fieldset>
      </div>
    </div>
