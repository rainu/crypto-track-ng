<template>
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <!-- fee info -->
      <wallet-io class="col-xs-12 col-lg-6" v-model="data.fee">{{$t('transaction.donation.fee')}}</wallet-io>
    </div>
      ...
      <div class="col-xs-12 col-lg-12">
        <fieldset>
          ...
          <div class="row">
            ...
            <!-- countervalue -->
            <counter-value class="col-xs-12 col-lg-12" v-model="data.out.countervalue">{{$t('transaction.donation.countervalues.out')}}</counter-value>
          </div>
        </fieldset>
      </div>
    </div>
