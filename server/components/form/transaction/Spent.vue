  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <template v-for="(curFee, i) in data.fee">
        <wallet-io class="col-xs-12 col-lg-6" :mandatory="false" :comment="true" v-model="data.fee[i]">
          <div class="row">
            <div class="col-xs-6">{{$t('transaction.spent.fee')}}</div>
            <div class="col-xs-3">
    ...
    <div class="row">
      <div class="col-xs-12 col-lg-12">
        <fieldset>
          <legend>{{$t('transaction.spent.exchangerates.title')}}</legend>
          <div class="row">

            <!-- exchangerate -->
            <exchange-rate class="col-xs-12 col-lg-6" v-model="data.out.exchangerate">{{$t('transaction.spent.exchangerates.out')}}</exchange-rate>
          </div>
        </fieldset>
      </div>
    </div>
